...
<!-- Museum -->
<div class="jumbotron jumbotron-fluid bg-cover Museum mt-5" style="background-image: url(<?= base_url('img/background/' . $Museum->photo) ?>)">
	<div class="container text-center">
		...
		<div class="row pt-3">
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 mb-4">
				<img class="" src="<?= base_url('img/Museum/ipa.png') ?>" alt="">
				<h5 class="mt-2">Museum</h5>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 mb-4">
				<img class="" src="<?= base_url('img/Museum/ips.png') ?>" alt="">
				<h5 class="mt-2">Brawijaya</h5>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 mb-4">
				<img class="" src="<?= base_url('img/Museum/Bahasa.png') ?>" alt="">
				<h5 class="mt-2">Malang</h5>
			</div>
		</div>
	</div>
</div>
